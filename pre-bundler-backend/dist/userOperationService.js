...
function resolveAddress(privateKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const simpleAccount = yield userop_1.default.Presets.Builder.SimpleAccount.init(new ethers_1.ethers.Wallet(ethers_1.ethers.SigningKey(_privateKey)), process.env.BUNDLER_RPC_URL);
